  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4">
    <div class="w-full max-w-sm">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Create your admin account to get started</p>
      </div>

      <!-- Card -->
      <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
        <form @submit.prevent="handleSetup" class="flex flex-col gap-4" novalidate>
          <!-- Error banner -->
          <div
            v-if="error"
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <div class="relative">
              <i class="mdi mdi-lock-check absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 pointer-events-none" />
              <input
                id="confirm-password"
